...
test_data <- tibble::tibble( 
    ...
    LIST        = purrr::map( 1:LENGTH, function(i) rnorm(i))
)
...
diffdf(test_data , test_data2 , warnings = FALSE)
```
...
diffdf( test_data , test_data2 , keys = c("GROUP1" , "GROUP2") , warnings = FALSE)
```
...
diff <- diffdf( iris , iris2, warnings = FALSE)
...
diffdf(dsin1  , dsin2 , warnings = FALSE)

diffdf(dsin1  , dsin2 , tolerance = 0.001 , warnings = FALSE)
```
...
diffdf(dsin1  , dsin2 , warnings = FALSE)
diffdf(dsin1  , dsin2 , warnings = FALSE, strict_numeric = FALSE)

dsin1 <- data.frame(x = as.character(c(1,2,3)), stringsAsFactors = FALSE)
dsin2 <- data.frame(x = as.factor(c(1,2,3)))

diffdf(dsin1  , dsin2 , warnings = FALSE)
diffdf(dsin1  , dsin2 , warnings = FALSE, strict_factor = FALSE)
```
