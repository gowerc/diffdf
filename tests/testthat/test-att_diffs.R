...
attr(TDAT_twovars_twoatts$INTEGER, 'atttwo') <- list(
    data.frame(
        x = rnorm(21),
        y = rnorm(21)
    ),
...
attr(TDAT_twovars_twoatts$BINARY, 'atttwo') <- tibble(
    list(
        data.frame(
            x = rnorm(11),
            y = rnorm(11)
...
attr(TDAT_twovars_twoatts2$INTEGER, 'atttwo') <- data.frame(
    x=rnorm(10),
    y=rnorm(10)
)
...
attr(TDAT_twovars_twoatts_diffname$INTEGER, 'atttwo2') <- data.frame(
    x=rnorm(10),
    y=rnorm(10)
)
...
test_that( "Check comparision of equal objects",{
    ...
    expect_true(
        rowcount(TDAT_twovars_twoatts, TDAT_twovars_twoatts, 0),
        'Check twoatts compares equal to itself'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts2, TDAT_twovars_twoatts2, 0),
        'Check twoatts2 compares equal to itself'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts2a, TDAT_twovars_twoatts2a, 0),
        'Check twoatts2a compares equal to itself'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts_diffname, TDAT_twovars_twoatts_diffname, 0),
...
test_that( "Check comparision of unequal objects",{
    ...
    expect_true(
        rowcount(TDAT_twovars_twoatts, TDAT_twovars_twoatts2, 4), 
        'compare twoatts with twoatts2'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts, TDAT_twovars_twoatts2a, 4), 
        'compare twoatts with twoatts2a'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts2, TDAT_twovars_twoatts2a, 2), 
        'compare twoatts2 with twoatts2a'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts, TDAT_twovars_twoatts_diffname, 8), 
        'compare twoatts with twoatts_diffname'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts2, TDAT_twovars_twoatts_diffname, 8), 
        'compare twoatts2 with twoatts_diffname'
    )
    
    expect_true(
        rowcount(TDAT_twovars_twoatts2a, TDAT_twovars_twoatts_diffname, 8), 
        'compare twoatts2a with twoatts_diffname'
    )
})
